...
const VARIANT_META: Record<Variant, { label: string; icon: string; desc: string }> = {
  facebook_caption: {
    label: "Facebook",
    icon: "📘",
    desc: "Great for Facebook property groups",
  },
  whatsapp_pitch: {
    label: "WhatsApp",
    icon: "💬",
          ...
          <div>
            <div className="mb-5">
              ...
              <p className="text-gray-500 text-sm mt-1">
                Fill in the property details — get ready-to-use copy in English, BM and 中文 in seconds.
              </p>
            </div>
            ...
            <form onSubmit={handleGenerate} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Add any selling points — the more detail, the better the copy
                </p>
              </div>
            ...
            {result && langVariants && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Click Copy to grab any variant</p>
                </div>
